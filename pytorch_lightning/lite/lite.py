...
from pytorch_lightning.overrides.distributed import DistributedSamplerProxy
...
class LightningLite(ABC):
    ...
    def _get_distributed_sampler(
        dataloader: DataLoader, **kwargs: Any
        ...
        if dataloader.sampler is None:
            ...
            return DistributedSamplerProxy(dataloader.sampler, **kwargs)
